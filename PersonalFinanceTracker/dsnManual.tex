...
\newtheorem{reqkSecurity}{Security Requirement}
\newtheorem{reqkPerformance}{Performance Requirement}
...
\include{scope}
\include{referenceDocuments}
\include{currentSystem}
\include{justificationForAndNatureOfChanges}
\include{conceptsForTheProposedSystem}
\include{operationalScenarios}
\include{summaryOfImpacts}
\include{analysisOfTheProposedSystem}
\include{chapterNine}
